...
```sh
  cd codesoft_ecommerce
  git clone https://github.com/KAYEMBAJONATHAN/codesoft_ecommerce.git (For the backend)
```

```sh
  cd Codesoft_E-commerce
  git clone https://github.com/KAYEMBAJONATHAN/Codesoft_E-commerce.git (For the Frontend)
```
